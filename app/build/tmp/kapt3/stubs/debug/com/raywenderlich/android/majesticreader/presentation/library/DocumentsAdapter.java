...
public final class DocumentsAdapter extends androidx.recyclerview.widget.RecyclerView.Adapter<com.raywenderlich.android.majesticreader.presentation.library.DocumentsAdapter.ViewHolder> {
    private final java.util.List<com.example.core.domain.Document> documents = null;
    private final com.bumptech.glide.RequestManager glide = null;
    private final kotlin.jvm.functions.Function1<com.example.core.domain.Document, kotlin.Unit> itemClickListener = null;
    ...
    java.util.List<com.example.core.domain.Document> newDocuments) {
    }
    
    public DocumentsAdapter(@org.jetbrains.annotations.NotNull()
    java.util.List<com.example.core.domain.Document> documents, @org.jetbrains.annotations.NotNull()
    com.bumptech.glide.RequestManager glide, @org.jetbrains.annotations.NotNull()
    kotlin.jvm.functions.Function1<? super com.example.core.domain.Document, kotlin.Unit> itemClickListener) {
        super();
    }
